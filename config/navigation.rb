...
SimpleNavigation::Configuration.run do |navigation|
  navigation.items do |n|
    ...
    n.item :security, safe_join([fa_icon('lock fw'), t('settings.account')]), edit_user_registration_url do |s|
      ...
      a.item :oauth_authentications, safe_join([fa_icon('list fw'), t('settings.oauth_authentications')]), settings_oauth_authentications_url
    end
    ...
    n.item :moderation, safe_join([fa_icon('gavel fw'), t('moderation.title')]), admin_pawoo_report_targets_url, if: proc { current_user.staff? } do |s|
      s.item :action_logs, safe_join([fa_icon('bars fw'), t('admin.action_logs.title')]), admin_action_logs_url
      s.item :reports, safe_join([fa_icon('flag fw'), t('admin.reports.title')]), admin_reports_url, highlights_on: %r{/admin/reports}
      s.item :report_targets, safe_join([fa_icon('flag fw'), t('pawoo.admin.report_targets.title')]), admin_pawoo_report_targets_url
      s.item :report_summations, safe_join([fa_icon('table fw'), t('pawoo.admin.report_summations.nav_title')]), admin_pawoo_report_summations_url
    ...
    n.item :admin, safe_join([fa_icon('cogs fw'), t('admin.title')]), admin_dashboard_url, if: proc { current_user.staff? } do |s|
      ...
      s.item :suggestion_tags, safe_join([fa_icon('tags fw'), t('admin.suggestion.title')]), admin_suggestion_tags_url, highlights_on: %r{/admin/suggestion_tags}
      s.item :trend_ng_words, safe_join([fa_icon('ban fw'), t('admin.trend_ng_word.title')]), admin_trend_ng_words_url, highlights_on: %r{/admin/trend_ng_words}
      s.item :galleries, safe_join([fa_icon('image fw'), 'ギャラリー']), admin_pawoo_galleries_url, highlights_on: %r{/admin/pawoo/galleries}
