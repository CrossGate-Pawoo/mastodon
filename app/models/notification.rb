...
class Notification < ApplicationRecord
  ...
  STATUS_INCLUDES = [:application, :preloadable_poll, :media_attachments, :tags, active_mentions: { account: :oauth_authentications }, reblog: [:application, :preloadable_poll, :media_attachments, :tags, active_mentions: { account: :oauth_authentications }, account: :oauth_authentications], account: :oauth_authentications].freeze
  ...
  cache_associated from_account: :oauth_authentications, status: STATUS_INCLUDES, mention: [status: STATUS_INCLUDES], favourite: [account: :oauth_authentications, status: STATUS_INCLUDES], follow: { account: :oauth_authentications }, poll: [status: STATUS_INCLUDES]
