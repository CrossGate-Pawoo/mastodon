...
import { PAWOO_EXTENSION_REPORT_TYPE_CHANGE } from 'pawoo/actions/extensions/reports';
...
export default function reports(state = initialState, action) {
  ...
  case REPORT_INIT:
    return state.withMutations(map => {
      ...
      if (state.getIn(['new', 'account_id']) !== action.account.get('id')) {
        ...
        map.setIn(['new', 'pawoo_report_type'], null);
  ...
  case PAWOO_EXTENSION_REPORT_TYPE_CHANGE:
    return state.setIn(['new', 'pawoo_report_type'], action.reportType);
