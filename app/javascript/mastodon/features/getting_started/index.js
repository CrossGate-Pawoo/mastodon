  ...
  render () {
    ...
    if (multiColumn) {
      ...
      navItems.push(
        ...
        <ColumnLink key={i++} icon='image' text={intl.formatMessage(messages.media_timeline)} to='/timelines/public/media' />,
        <ColumnLink key={i++} icon='globe' text={intl.formatMessage(messages.public_timeline)} to='/timelines/public' />,
        <ColumnLink key={i++} icon='user-plus' text={intl.formatMessage(messages.suggested_accounts)} to='/suggested_accounts' />,
      );
